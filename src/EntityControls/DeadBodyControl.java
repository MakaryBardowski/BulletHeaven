 ...
 * @author 48793
 */
public class DeadBodyControl extends AbstractControl implements Savable, Cloneable {
    ...
    public DeadBodyControl(Mob owner,float expirationTimeMillis) {
        this.owner = owner;
    ...
    protected void controlUpdate(float tpf) {
        ...
        if(timePassed >= expirationTime && spatial != null){
            owner.getNode().removeFromParent();
    ...
    public Control cloneForSpatial(Spatial spatial) {
        final DeadBodyControl control = new DeadBodyControl(owner,expirationTime);
